...
const routes = [
    ...
    { path: '/dashboard', name: 'dashboard', component: () => import('@/views/dashboard/Index.vue'),
        children: [
            ...
            { path: '/product', name: 'product.create', component: () => import('@/views/product/Create.vue')},
            { path: '/product', name: 'product.edit', component: () => import('@/views/product/Edit.vue')},
            { path: '/store', name: 'store.index', component: () => import('@/views/store/Index.vue')},
            { path: '/store', name: 'store.create', component: () => import('@/views/store/Create.vue')},
            { path: '/store', name: 'store.edit', component: () => import('@/views/store/Edit.vue')},
